...
It is three parts, and the enclosing brackets ( { ' " are very specific and change between the terminal command(*above*) and SSH command(*below*) so take careful not when copying commands.
